<template>
  <q-page>
    ...
    <div class="row q-col-gutter-lg q-pa-lg">
      <div class="col-10">
        <q-input filled v-model="textSearch" label="Search" />
      </div>

      <div class="col-2 flex justify-between items-center">
        <q-btn class="full-width full-height" @click="search()">
